        ...
        {users.map(item=>{
            ...
            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
              ...
              <div class="p-6">
                ...
                {/* <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">{item.rating{rate, count}}</h2> */}

                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">{item.price}</h2>
